...
public class RecycleView_Adapter_N2 extends RecyclerView.Adapter<RecycleView_Adapter_N2.MyViewHolder>{

        Context context;
        ArrayList<RecycleView_Model> foodModels4;

public RecycleView_Adapter_N2(Context context, ArrayList<RecycleView_Model> foodModels4){
...
@NonNull
@Override
public RecycleView_Adapter_N2.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        //Inflate the layout (Giving look)
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.yesterday_rv, parent, false);
        return new RecycleView_Adapter_N2.MyViewHolder(view);
        }

@Override
public void onBindViewHolder(@NonNull RecycleView_Adapter_N2.MyViewHolder holder, int position) {
