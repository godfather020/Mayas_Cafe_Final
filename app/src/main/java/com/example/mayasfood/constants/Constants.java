...
public class Constants {
    ...
    public static final String phoneNumError = "Enter a valid phone number";
    public static String cc = "+1";
    public static final int duration = 60;
    public static int[] foodImage = {R.drawable.group_117, R.drawable.group_118, R.drawable.group_119, R.drawable.group_120, R.drawable.group_117, R.drawable.group_118,R.drawable.group_119, R.drawable.group_120, R.drawable.group_117};
